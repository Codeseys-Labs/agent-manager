...
[![Tests: 3653 pass](https://img.shields.io/badge/tests-3653%20pass-green.svg)](#development)
...
2. Lint — `biome check`
3. Test with coverage — `bun test --coverage --coverage-reporter=text --coverage-reporter=lcov --config=/dev/null` (3653 tests)
